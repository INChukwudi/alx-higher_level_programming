...
class TestSquare_size(unittest.TestCase):
    """
    Unittests for testing the size initialization of the Square class
    """
...
class TestSquare_x(unittest.TestCase):
    """
    Unittests for testing the initialization of Square x attribute
    """
...
class TestSquare_y(unittest.TestCase):
    """
    Unittests for testing the initialization of Square y attribute
    """
...
class TestSquare_order_of_initialization(unittest.TestCase):
    """
    Unittests for testing the order of Square attribute initialization
    """
...
class TestSquare_stdout(unittest.TestCase):
    """
    Unittests for testing the __str__ and display methods of Square class
    """
...
class TestSquare_update_kwargs(unittest.TestCase):
    ...
    def test_update_kwargs_two(self):
        s = Square(10, 10, 10, 10)
        s.update(size=10, id=2)
        self.assertEqual("[Square] (2) 10/10 - 10", str(s))
