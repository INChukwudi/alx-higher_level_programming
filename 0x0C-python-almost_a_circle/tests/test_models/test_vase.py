...
class TestBase_instantiation(unittest.TestCase):
    """
    Unittests for testing instantiation and usage of the Base class
    """
...
class TestBase_to_json_string(unittest.TestCase):
    """
    Unittests for testing the to_json_string method of Base class
    """
...
class TestBase_from_json_string(unittest.TestCase):
    """
    Unittests for testing the from_json_string method of Base class
    """
...
class TestBase_load_from_file(unittest.TestCase):
    """
    Unittests for testing the load_from_file_method of Base class
    """
